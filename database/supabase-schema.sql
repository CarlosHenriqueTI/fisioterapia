...
-- Inserir administrador proprietário padrão (apenas se não existir)
-- IMPORTANTE: Este usuário deve ser criado manualmente no Supabase Auth
-- Email: admin@bmespaco.com.br | Senha: BmEspaco2025!
INSERT INTO users (
  id,
  email, 
  tipo_usuario, 
...
SELECT 
  ...
  'CREFITO-12345'
WHERE NOT EXISTS (
  SELECT 1 FROM users WHERE email = 'admin@bmespaco.com.br'
);
